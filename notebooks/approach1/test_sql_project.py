...
class MySqlProjectTest(NutterFixture):
    def __init__(self):
    ...
    def run_sql_project(self):
        ...
        dbutils.notebook.run('sql_project', 600, args)

    def assertion_sql_project(self):
...
result = MySqlProjectTest().execute_tests()
