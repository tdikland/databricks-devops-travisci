...
class MyPythonProjectTest(NutterFixture):
    def __init__(self):
    ...
    def before_python_project(self):
    ...
    def run_python_project(self):
        ...
        dbutils.notebook.run('python_project', 600, args)

    def assertion_python_project(self):
...
result = MyPythonProjectTest().execute_tests()
